  ...
  <div class="w-full mx-auto max-w-7xl flex flex-row items-center justify-between py-2 px-8 h-16" style="min-height: 4rem;">
      <div class="flex flex-row items-center gap-8">
        ...
        <ul class="flex flex-row gap-4 items-center text-sm font-semibold">
            ...
            <a v-if="!logged" id="login" class="px-4 py-2 text-xs text-white bg-green-600 rounded-md font-semibold hover:bg-green-400 duration-300" href="http://10.12.2.4:3000/api/login">login</a>
...
export default defineComponent({
  ...
  mounted() {
    axios
        .post("http://10.12.2.4:3000/api/login/login_verification", {}, { withCredentials: true })
