<template>
	<div class="w-20 group hover:!w-80 lg:hover:!w-1/3 lg:w-1/3 max-w-sm h-full flex flex-col border-r transition-all duration-300">
      ...
      <div class="relative text-gray-600 focus-within:text-gray-400">
        ...
        <input aria-placeholder="Look for rooms or create new ones" placeholder="Look for rooms..." class="py-2 pl-10 block w-full rounded bg-gray-100 outline-none focus:text-gray-700" type="search" name="search" required="" autocomplete="search" v-model="roomSearch">
      </div>
    </div>
